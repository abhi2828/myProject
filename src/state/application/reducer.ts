...
export interface ApplicationState {
  ...
  readonly openSwapModal: boolean
}
...
const applicationSlice = createSlice({
  ...
  reducers: {
    ...
    setSwapModal(state, action) {
      state.openSwapModal = action.payload
    },
...
export const { updateChainId, setFiatOnrampAvailability, setOpenModal, setSwapModal, addPopup, removePopup } =
